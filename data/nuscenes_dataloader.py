...
# from data_utils import classify_speed_level
# debug
...
class TrainDatasetMultiSeq_GAN(Dataset):
    def __init__(self, dataset_root=None, future_frame_skip=0, voxel_size=(0.25, 0.25, 0.4),
                 area_extents=np.array([[-32., 32.], [-32., 32.], [-3., 2.]]),  num_past_frames=5,
                 num_future_frames=20, num_category=5, cache_size=10000):
        """
    ...
    def __getitem__(self, idx):
        ...
        # for gt_dict in gt_dict_list[0]:
        gt_dict = gt_dict_list[0]
        dims = gt_dict['3d_dimension']
        num_future_pcs = gt_dict['num_future_pcs']
        pixel_indices = gt_dict['pixel_indices']
        trans_matrices = gt_dict['trans_matrices']
...
if __name__ == "__main__":
    ...
    # data_nuscenes = TrainDatasetMultiSeq(dataset_root='/home/qianka/Motion/WeakMotion/WeakMotion-New-2/data/input-data/test')
    data_nuscenes = DatasetSingleSeq(dataset_root='/home/qianka/Motion/WeakMotion/WeakMotion-New-2/data/input-data/test')
    a = data_nuscenes[0]
