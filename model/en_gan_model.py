...
from model.gan_model import DiscriminatorAC, GeneratorAC, QHead, DHead
...
class En_GAN_MotionNet(nn.Module):
    ...
    def forward(self, bevs):
        ...
        # Backbone network
        x = self.stpn(bevs) # (Batch, dim, h, w)
